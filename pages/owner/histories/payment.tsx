        ...
        <div className="grid gap-6">
          <div className="grid w-max gap-2 border-l-4 border-primary p-[1rem_0_1rem_1rem]">
            ...
            <div className="grid gap-[2px]">
              <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
                ...
                <p className="font-bold text-primary">{props.id_transaksi}</p>
              </div>
              <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
                <div className="text-sm font-medium text-default-600">
                  Total Pembayaran
          ...
          {loading ? (
            <Button
              ...
              className={`${loading ? "cursor-not-allowed justify-self-end bg-primary font-medium text-white" : ""}`}
            >
              Tunggu
            </Button>
          ) : (
            <Button
              ...
              className="justify-self-end bg-primary font-medium text-white"
            >
              Bayar
            </Button>
          )}
