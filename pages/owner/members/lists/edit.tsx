...
export default function MemberUpdate(
  ...
  async function handleUpdate() {
    ...
    try {
      ...
      return router.push("/owner/members/lists");
    } catch (error) {
  ...
  return (
    <Layout title="Update Member">
      <Container className="gap-12">
        <ButtonBack onClick={() => router.push("/owner/members/lists")}>
          Kembali
        </ButtonBack>
          ...
          <div className="grid w-max gap-2 border-l-4 border-primary p-[1rem_0_1rem_1rem]">
            ...
            <div className="grid gap-[2px]">
              <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
                ...
                <p className="font-bold text-primary">{props.member?.nama}</p>
              </div>
              <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
                <div className="text-sm font-medium text-default-600">
                  Level Member
                ...
                <div className="font-medium">:</div>
                <p className="font-bold text-primary">{props.member?.level}</p>
              </div>
            </div>
          </div>
