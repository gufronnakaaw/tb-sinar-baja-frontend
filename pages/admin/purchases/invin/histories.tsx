        ...
        <div className="grid w-max gap-2 border-l-4 border-teal-500 p-[1rem_0_1rem_1rem]">
          ...
          <div className="grid gap-[2px]">
            <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
              ...
              <p className="font-bold text-teal-500">{invoice.nomor_invoice}</p>
            </div>
            <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
              <div className="text-sm font-medium text-default-600">
                ID Preorder
              ...
              <div className="font-medium">:</div>
              <p className="font-bold text-teal-500">{invoice.preorder_id}</p>
            </div>
            <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
              <div className="text-sm font-medium text-default-600">
                Tujuan Preorder
              ...
              <div className="font-medium">:</div>
              <p className="font-bold text-teal-500">{invoice.nama_supplier}</p>
            </div>
            <div className="grid grid-cols-[170px_10px_10fr]  gap-1 text-sm text-default-900">
              <div className="text-sm font-medium text-default-600">
                Sumber Preorder
              ...
              <div className="font-medium">:</div>
              <p className="font-bold capitalize text-teal-500">
